...
public class max_heap {
    ...
    max_heap(int[] ar) {
        ...
        for (int i = (HEAP_SIZE - 1) / 2; i >= 0; i--) {
            max_heapify(i);
            /*
             * This is also the way of doing this build max heap property left = 2 * i + 1;
             * right = 2 * i + 2; if(left > HEAP_SIZE) max_heapify(i); if(right > HEAP_SIZE)
             * max_heapify(i); if(heap.get(i) < heap.get(left) || heap.get(i) <
             * heap.get(right)) { max_heapify(i); }
             */
        }
    ...
    void max_heapify(int index) {
        ...
        if (index > HEAP_SIZE)
            return;
        else if (left > HEAP_SIZE && right > HEAP_SIZE)
            return;
        ...
        // Has left as well as right child
    ...
    public static void main(String argv[]) throws IOException {
        ...
        /*
         * System.out.println(mp.extract_max()); mp.display();
         */
